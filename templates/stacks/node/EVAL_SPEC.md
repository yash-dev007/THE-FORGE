...
|-----------|--------|---------------------|
| PERF_SCORE | 0.20 | Placeholder constant — see `docs/EVAL_BENCHMARKS.md` to wire benchmarks |
...
| `autocannon` | PERF | `npm install --save-dev autocannon` (see `docs/EVAL_BENCHMARKS.md`) |
