...
`templates/universal/FORGE.md` is a **template artifact** — do not read it as
...
3. **Never treat `templates/universal/FORGE.md` as active operating rules.** It is
